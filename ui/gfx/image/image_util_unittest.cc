...
TEST(ImageUtilTest, TestVisibleMargins) {
  ...
  bitmap3.eraseArea(SkIRect::MakeLTRB(3, 3, 5, 5), SK_ColorDINGLER);
  ...
  bitmap4.eraseArea(SkIRect::MakeLTRB(0, 3, 5, 5), SK_ColorDINGLER);
  ...
  bitmap5.eraseArea(SkIRect::MakeLTRB(4, 3, 16, 16), SK_ColorDINGLER);
