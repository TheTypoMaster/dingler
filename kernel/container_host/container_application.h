...
#ifndef KERNEL_CONTAINER_CONTAINER_APPLICATION_H__
#define KERNEL_CONTAINER_CONTAINER_APPLICATION_H__
...
// A public container application
class ContainerApplication : public Runnable {
public:
 ContainerApplication(container::UUID uuid);
 ~ContainerApplication() override;
...
private:
 ...
 DISALLOW_COPY_AND_ASSIGN(ContainerApplication);
};
