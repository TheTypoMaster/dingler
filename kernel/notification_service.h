...
#ifndef KERNEL_NOTIFICATION_SERVICE_H_
#define KERNEL_NOTIFICATION_SERVICE_H_

#include "kernel/notification_details.h"
#include "kernel/notification_source.h"
...
class NotificationService {
 public:
  ...
  static Source<void> AllShellContextsAndSources() {
...
#endif  // DINGLER_MODULES_SHELL_NOTIFICATION_SERVICE_H_
