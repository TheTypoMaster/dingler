// Copyright (c) 2014 Dingler Authors. All rights reserved.
...
public:
  ...
  virtual bool ShouldSandbox() { return false; }
  ...
  virtual base::EnvironmentMap GetEnvironment() { return base::EnvironmentMap(); }
