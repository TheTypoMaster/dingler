...
#ifndef COMMON_FILE_DESCRIPTOR_INFO_H_
#define COMMON_FILE_DESCRIPTOR_INFO_H_
...
class FileDescriptorInfo {
 public:
  ...
  virtual void Transfer(int id, base::win::ScopedHandle fd) = 0;
...
#endif  // STRIPES_MODULES_ENGINE_FILE_DESCRIPTOR_INFO_H_
