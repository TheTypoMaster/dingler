...
#ifndef COMMON_CHILD_THREAD_IMPL_H_
#define COMMON_CHILD_THREAD_IMPL_H_
...
#include "common/child_thread.h"
#include "ipc/ipc_message.h"  // For IPC_MESSAGE_LOG_ENABLED.

#if defined(OS_MACOSX) && !defined(OS_IOS)
#include "modules/common/mac/io_surface_manager_token.h"
#endif
...
class ChildThreadImpl
 ...
 /* ChildHistogramMessageFilter* child_histogram_message_filter() const {
  ...
  IPC::AttachmentBroker* GetAttachmentBroker();
...
#endif  // STRIPES_COMMON_CHILD_THREAD_IMPL_H_
