...
#ifndef IMAGE_BASE_INFRASTRUCTURE_OPERATORS_H_
#define IMAGE_BASE_INFRASTRUCTURE_OPERATORS_H_
...
struct Hash {
  ...
  size_t operator()(const base::StringPiece& v) const {
...
#endif  // IMAGE_BASE_INFRASTRUCTURE_OPERATORS_H_
