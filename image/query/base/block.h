...
#ifndef IMAGE_BASE_INFRASTRUCTURE_BLOCK_H_
#define IMAGE_BASE_INFRASTRUCTURE_BLOCK_H_
...
// Represents a collection of column linked materialized in memory.
...
#endif  // IMAGE_BASE_INFRASTRUCTURE_BLOCK_H_
