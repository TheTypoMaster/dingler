...
#ifndef IMAGE_BASE_EXCEPTION_EXCEPTION_MACROS_H_
#define IMAGE_BASE_EXCEPTION_EXCEPTION_MACROS_H_
...
#define THROW(exception)                                                       \
  do {                                                                         \
    return ::container::common::Failure((exception)->            \
...
#define PROPAGATE_ON_FAILURE_WITH_CONTEXT(result,                              \
                                          ...
                                          stack_frame_context)                 \
  do {                                                                         \
    ::container::Exception* for_type_matching = NULL;    \
    ::container::Exception* exception =                  \
        ::container::common::ConvertException(                              \
...
#endif  // IMAGE_BASE_EXCEPTION_EXCEPTION_MACROS_H_
