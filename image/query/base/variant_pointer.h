...
#ifndef IMAGE_BASE_INFRASTRUCTURE_VARIANT_POINTER_H_
#define IMAGE_BASE_INFRASTRUCTURE_VARIANT_POINTER_H_
...
class VariantConstPointer {
 public:
  ...
  // Returns a typed pointer to variable-length data.
  const base::StringPiece* as_variable_length() const {
...
#endif  // IMAGE_BASE_INFRASTRUCTURE_VARIANT_POINTER_H_
