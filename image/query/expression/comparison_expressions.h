...
#ifndef IMAGE_EXPRESSION_CORE_COMPARISON_EXPRESSIONS_H_
#define IMAGE_EXPRESSION_CORE_COMPARISON_EXPRESSIONS_H_
...
// constants.
// To comply with the BBQL standard, IN returns NULL not only if the expr is
...
#endif  // IMAGE_EXPRESSION_CORE_COMPARISON_EXPRESSIONS_H_
