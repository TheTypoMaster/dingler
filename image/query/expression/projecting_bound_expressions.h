...
#ifndef IMAGE_EXPRESSION_CORE_PROJECTING_BOUND_EXPRESSIONS_H_
#define IMAGE_EXPRESSION_CORE_PROJECTING_BOUND_EXPRESSIONS_H_
...
#endif  // IMAGE_EXPRESSION_CORE_PROJECTING_BOUND_EXPRESSIONS_H_
