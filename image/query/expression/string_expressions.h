...
#ifndef IMAGE_EXPRESSION_CORE_STRING_EXPRESSIONS_H_
#define IMAGE_EXPRESSION_CORE_STRING_EXPRESSIONS_H_
...
const Expression* ConcatWithSeparator(const base::StringPiece& separator,
...
// Substring(str, 0, len) always returns an empty string (as in MyBBQL).
...
#endif  // IMAGE_EXPRESSION_CORE_STRING_EXPRESSIONS_H_
