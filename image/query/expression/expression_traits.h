...
#ifndef IMAGE_EXPRESSION_VECTOR_EXPRESSION_TRAITS_H_
#define IMAGE_EXPRESSION_VECTOR_EXPRESSION_TRAITS_H_
...
#include "image/query/expression/column_validity_checkers.h"
#include "image/query/expression/expression_evaluators.h"
#include "image/query/expression/operators.pb.h"
#include "image/query/base/operators.h"
#include "image/query/expression/simd_operators.h"
...
struct BaseUnaryExpressionTraits<OPERATOR_CAST_QUIET>
  ...
  static const string FormatDescription(const string& child) {
    return base::StringPrintf("CAST(%s)", child.c_str());
  }
  static const string FormatDescription(const string& child, DataType to_type) {
   return base::StringPrintf("CAST<%s>(%s)",
...
struct BaseUnaryExpressionTraits<OPERATOR_PARSE_STRING_QUIET>
  ...
  static const string FormatDescription(const string& child) {
   return base::StringPrintf("%s(%s)", name().c_str(), child.c_str());
  }
  static const string FormatDescription(const string& child, DataType to_type) {
...
struct BaseUnaryExpressionTraits<OPERATOR_NOT>
  ...
  static const string FormatDescription(const string& child) {
   return base::StringPrintf("(NOT %s)", child.c_str());
  }
};
...
struct BaseUnaryExpressionTraits<OPERATOR_COPY>
  ...
  static const string FormatDescription(const string& child) {
   return base::StringPrintf("COPY(%s)", child.c_str());
  }
};
...
struct BaseUnaryExpressionTraits<OPERATOR_NUMERIC_TO_BOOL>
  ...
  static const string FormatDescription(const string& child) {
   return base::StringPrintf("TO_BOOL(%s)", child.c_str());
  }
};
...
struct BaseUnaryExpressionTraits<OPERATOR_BOOL_TO_NUMERIC>
  ...
  static const string FormatDescription(const string& child) {
   return base::StringPrintf("FROM_BOOL(%s)", child.c_str());
  }
};
...
struct BaseUnaryExpressionTraits<OPERATOR_BITWISE_NOT>
  ...
  static const string FormatDescription(const string& child) {
   return base::StringPrintf("(~%s)", child.c_str());
  }
};
...
struct BaseUnaryExpressionTraits<OPERATOR_IS_ODD>
  ...
  static const string FormatDescription(const string& child) {
   return base::StringPrintf("IS_ODD(%s)", child.c_str());
  }
};
...
struct BaseUnaryExpressionTraits<OPERATOR_IS_EVEN>
  ...
  static const string FormatDescription(const string& child) {
   return base::StringPrintf("IS_EVEN(%s)", child.c_str());
  }
};
...
struct BaseUnaryExpressionTraits<OPERATOR_UNIXTIMESTAMP>
  ...
  static const string FormatDescription(const string& child) {
   return base::StringPrintf("UNIXTIMESTAMP(%s)", child.c_str());
  }
};
...
struct BaseUnaryExpressionTraits<OPERATOR_FROMUNIXTIME>
  ...
  static const string FormatDescription(const string& child) {
   return base::StringPrintf("FROMUNIXTIME(%s)", child.c_str());
  }
  static const bool is_safe = true;
...
struct UnaryExpressionTraits<OPERATOR_CAST_QUIET>
  ...
  static const string FormatBoundDescription(const string& argument,
                                             DataType from_type,
                                             DataType to_type) {
   return base::StringPrintf("CAST_%s_TO_%s(%s)",
...
struct BaseBinaryExpressionTraits<OPERATOR_ADD>
  ...
  static const string FormatDescription(const string& left,
                                        const string& right) {
   return base::StringPrintf("(%s + %s)", left.c_str(), right.c_str());
  }
};
...
struct BaseBinaryExpressionTraits<OPERATOR_IF_NULL> {
  ...
  static const string FormatDescription(const string& left,
                                        const string& right) {
   return base::StringPrintf("IFNULL(%s, %s)", left.c_str(), right.c_str());
  }
};
...
struct BaseBinaryExpressionTraits<OPERATOR_STRING_OFFSET> {
  ...
  static const string FormatDescription(const string& left,
                                        const string& right) {
   return base::StringPrintf("%s(%s, %s)", name().c_str(), left.c_str(),
                        right.c_str());
  }
};
...
struct BaseBinaryExpressionTraits<OPERATOR_SUBSTRING_SIGNALING> {
  ...
  static const string FormatDescription(const string& left,
                                        const string& right) {
   return base::StringPrintf("SUBSTRING(%s, %s)", left.c_str(), right.c_str());
  }
};
...
#endif  // IMAGE_EXPRESSION_VECTOR_EXPRESSION_TRAITS_H_
