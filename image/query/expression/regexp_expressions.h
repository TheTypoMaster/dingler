...
#ifndef IMAGE_EXPRESSION_CORE_REGEXP_EXPRESSIONS_H_
#define IMAGE_EXPRESSION_CORE_REGEXP_EXPRESSIONS_H_
...
const Expression* RegexpRewrite(const Expression* str,
 const base::StringPiece& pattern,
 const base::StringPiece& rewrite);
...
#endif  // IMAGE_EXPRESSION_CORE_REGEXP_EXPRESSIONS_H_
