...
#ifndef IMAGE_EXPRESSION_CORE_DATE_EVALUATORS_H_
#define IMAGE_EXPRESSION_CORE_DATE_EVALUATORS_H_
...
struct DateFormat {
 base::StringPiece operator()(int64 datetime, const base::StringPiece& format,
                         Arena* arena);
};
...
#endif  // IMAGE_EXPRESSION_CORE_DATE_EVALUATORS_H_
