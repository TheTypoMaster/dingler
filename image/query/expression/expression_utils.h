...
#ifndef IMAGE_EXPRESSION_INFRASTRUCTURE_EXPRESSION_UTILS_H_
#define IMAGE_EXPRESSION_INFRASTRUCTURE_EXPRESSION_UTILS_H_
...
#endif  // IMAGE_EXPRESSION_INFRASTRUCTURE_EXPRESSION_UTILS_H_
