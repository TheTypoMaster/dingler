...
#ifndef IMAGE_EXPRESSION_VECTOR_VECTOR_PRIMITIVES_H_
#define IMAGE_EXPRESSION_VECTOR_VECTOR_PRIMITIVES_H_
...
#endif  // IMAGE_EXPRESSION_VECTOR_VECTOR_PRIMITIVES_H_
