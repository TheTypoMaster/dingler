...
#include "image/query/expression/date_expressions.h"
...
#include "image/query/expression/date_bound_expressions.h"
#include "image/query/expression/date_evaluators.h"  // IWYU pragma: keep
