...
#ifndef IMAGE_EXPRESSION_TEMPLATED_CAST_BOUND_EXPRESSION_H_
#define IMAGE_EXPRESSION_TEMPLATED_CAST_BOUND_EXPRESSION_H_
...
#endif  // IMAGE_EXPRESSION_TEMPLATED_CAST_BOUND_EXPRESSION_H_
