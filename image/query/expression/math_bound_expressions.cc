...
#include "image/query/expression/math_bound_expressions.h"
...
#include "image/query/expression/arithmetic_bound_expressions.h"
#include "image/query/expression/elementary_bound_expressions.h"
#include "image/query/expression/math_evaluators.h"  // IWYU pragma: keep
#include "image/query/expression/expression_utils.h"
#include "image/query/expression/terminal_bound_expressions.h"
...
FailureOrOwned<BoundExpression> BoundAbs(BoundExpression* argument,
  ...
  if (input_type == UINT32 || input_type == UINT64) {
   return common::Success(argument_ptr.release());
  }
