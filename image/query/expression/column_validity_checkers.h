...
#ifndef IMAGE_EXPRESSION_VECTOR_COLUMN_VALIDITY_CHECKERS_H_
#define IMAGE_EXPRESSION_VECTOR_COLUMN_VALIDITY_CHECKERS_H_
...
#endif  // IMAGE_EXPRESSION_VECTOR_COLUMN_VALIDITY_CHECKERS_H_
