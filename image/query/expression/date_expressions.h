...
#ifndef IMAGE_EXPRESSION_CORE_DATE_EXPRESSIONS_H_
#define IMAGE_EXPRESSION_CORE_DATE_EXPRESSIONS_H_
...
const Expression* ConstDateTime(const base::StringPiece& value);
...
const Expression* ParseDateTime(const base::StringPiece& format, const Expression* e);
...
#endif  // IMAGE_EXPRESSION_CORE_DATE_EXPRESSIONS_H_
