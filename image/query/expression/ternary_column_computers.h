...
#ifndef IMAGE_EXPRESSION_VECTOR_TERNARY_COLUMN_COMPUTERS_H_
#define IMAGE_EXPRESSION_VECTOR_TERNARY_COLUMN_COMPUTERS_H_
...
FailureOrVoid CheckAndNull(const Column& left_column,
  ...
  if (failures > 0) {
    string message =
        base::StringPrintf("Evaluation error (invalid data in %d rows)", failures);
...
#endif  // IMAGE_EXPRESSION_VECTOR_TERNARY_COLUMN_COMPUTERS_H_
