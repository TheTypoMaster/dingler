...
#ifndef IMAGE_EXPRESSION_BASE_EXPRESSION_H_
#define IMAGE_EXPRESSION_BASE_EXPRESSION_H_
...
class BoundExpression {
 public:
  ...
  virtual void CollectReferredAttributeNames(
   std::set<string>* referred_attribute_names) const = 0;
...
class BoundExpressionList {
 public:
  ...
  // depends on. Does not remove the previous content of the set.
  void CollectReferredAttributeNames(std::set<string>* referred_attribute_names)
      const;
...
#endif  // IMAGE_EXPRESSION_BASE_EXPRESSION_H_
