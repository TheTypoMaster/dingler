...
#ifndef IMAGE_EXPRESSION_VECTOR_UNARY_COLUMN_COMPUTERS_H_
#define IMAGE_EXPRESSION_VECTOR_UNARY_COLUMN_COMPUTERS_H_
...
#endif  // IMAGE_EXPRESSION_VECTOR_UNARY_COLUMN_COMPUTERS_H_
