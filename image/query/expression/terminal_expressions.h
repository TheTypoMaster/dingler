...
#ifndef IMAGE_EXPRESSION_INFRASTRUCTURE_TERMINAL_EXPRESSIONS_H_
#define IMAGE_EXPRESSION_INFRASTRUCTURE_TERMINAL_EXPRESSIONS_H_

#include "base/strings/string_piece.h"
//#include "image/query/utils/integral_types.h"
...
#include "image/query/expression/elementary_const_expressions.h"
...
const Expression* ConstString(const base::StringPiece& value);
const Expression* ConstBinary(const base::StringPiece& value);
...
#endif  // IMAGE_EXPRESSION_INFRASTRUCTURE_TERMINAL_EXPRESSIONS_H_
