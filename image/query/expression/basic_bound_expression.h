...
#ifndef IMAGE_EXPRESSION_INFRASTRUCTURE_BASIC_BOUND_EXPRESSION_H_
#define IMAGE_EXPRESSION_INFRASTRUCTURE_BASIC_BOUND_EXPRESSION_H_
...
class BasicBoundExpression : public BoundExpression {
 ...
 private:
  ...
  virtual FailureOrVoid PostInit() { return common::Success(); }
...
#endif  // IMAGE_EXPRESSION_INFRASTRUCTURE_BASIC_BOUND_EXPRESSION_H_
