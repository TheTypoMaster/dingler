...
#ifndef IMAGE_CURSOR_CORE_COALESCE_H_
#define IMAGE_CURSOR_CORE_COALESCE_H_
...
Operation* Coalesce(const std::vector<Operation*>& children);
...
FailureOrOwned<Cursor> BoundCoalesce(const std::vector<Cursor*>& children);
...
#endif  // IMAGE_CURSOR_CORE_COALESCE_H_
