...
#ifndef IMAGE_CURSOR_INFRASTRUCTURE_TABLE_H_
#define IMAGE_CURSOR_INFRASTRUCTURE_TABLE_H_
...
#include "image/query/cursor/row_copier.h"
...
class TableSink : public Sink {
 public:
  ...
  virtual FailureOr<rowcount_t> Write(const View& data) {
    return common::Success(table_->AppendView(data));
  }
  virtual FailureOrVoid Finalize() { return common::Success(); }
 private:
  Table* table_;
};
...
#endif  // IMAGE_CURSOR_INFRASTRUCTURE_TABLE_H_
