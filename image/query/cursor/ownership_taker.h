...
#ifndef IMAGE_CURSOR_CORE_OWNERSHIP_TAKER_H_
#define IMAGE_CURSOR_CORE_OWNERSHIP_TAKER_H_
...
inline FailureOrOwned<Cursor> TurnIntoCursor(Operation* operation) {
  ...
  return common::Success(TakeOwnership(result.release(), operation_ptr.release()));
}

}  // namespace image

#endif  // IMAGE_CURSOR_CORE_OWNERSHIP_TAKER_H_
