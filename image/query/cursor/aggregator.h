...
#ifndef IMAGE_CURSOR_CORE_AGGREGATOR_H_
#define IMAGE_CURSOR_CORE_AGGREGATOR_H_
...
class Aggregator {
 ...
 private:
  ...
  std::vector<std::pair<int, linked_ptr<aggregations::ColumnAggregator> > >
      column_aggregator_;
...
#endif  // IMAGE_CURSOR_CORE_AGGREGATOR_H_
