...
#ifndef IMAGE_CURSOR_INFRASTRUCTURE_ROW_H_
#define IMAGE_CURSOR_INFRASTRUCTURE_ROW_H_
...
struct DirectRowSourceReader {
  ...
  bool fetch_variable_length_using_allocator(
    ...
    if (deep_copy) {
      ...
      output->set(static_cast<const char *>(buffer), data.size());
    } else {
...
#endif  // IMAGE_CURSOR_INFRASTRUCTURE_ROW_H_
