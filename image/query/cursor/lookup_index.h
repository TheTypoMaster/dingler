...
#ifndef IMAGE_CURSOR_BASE_LOOKUP_INDEX_H_
#define IMAGE_CURSOR_BASE_LOOKUP_INDEX_H_
...
class ResultLookupIndexView {
 ...
 private:
  ResultLookupIndexView(const LookupIndexView* view, bool is_eos)
      : result_(common::Success(view)),
        is_eos_(is_eos) {}

  explicit ResultLookupIndexView(Exception* exception)
   : result_(common::Failure(exception)),
        is_eos_(false) {}
...
#endif  // IMAGE_CURSOR_BASE_LOOKUP_INDEX_H_
