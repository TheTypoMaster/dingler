...
#ifndef DINGLER_BASE_PORT_H_
#define DINGLER_BASE_PORT_H_
...
// The uint mess:
// mybbql.h sets _GNU_SOURCE which sets __USE_MISC in <features.h>
// sys/types.h typedefs uint if __USE_MISC
// mybbql typedefs uint if HAVE_UINT not set
...
// overflow.
#define vsnprintf _vsnprintf //base_port_MSVC_vsnprintf
//BASE_PORT_MSVC_DLL_MACRO
//    int base_port_MSVC_vsnprintf(char *str, size_t size,
//                                 const char *format, va_list ap);
#define snprintf _snprintf//base_port_MSVC_snprintf
//BASE_PORT_MSVC_DLL_MACRO
...
#  define HASH_IMAGE_DECLARATION_START
#  define HASH_IMAGE_DECLARATION_END
#else
#  define HASH_IMAGE_DECLARATION_START  namespace HASH_NAMESPACE {
#  define HASH_IMAGE_DECLARATION_END    }
#endif
