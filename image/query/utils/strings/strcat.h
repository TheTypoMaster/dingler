...
//
#ifndef DINGLER_STRINGS_STRCAT_H_
#define DINGLER_STRINGS_STRCAT_H_
...
struct AlphaNum {
  ...
  AlphaNum(const base::StringPiece &pc) : piece(pc) {}  // NOLINT(runtime/explicit)
  ...
  base::StringPiece::size_type size() const { return piece.size(); }
