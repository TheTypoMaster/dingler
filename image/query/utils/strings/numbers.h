...
#ifndef DINGLER_STRINGS_NUMBERS_H_
#define DINGLER_STRINGS_NUMBERS_H_
...
bool safe_strto32_base(base::StringPiece text, int32* value, int base);
bool safe_strto64_base(base::StringPiece text, int64* value, int base);
bool safe_strtou32_base(base::StringPiece text, uint32* value, int base);
bool safe_strtou64_base(base::StringPiece text, uint64* value, int base);
bool safe_strtosize_t_base(base::StringPiece text, size_t* value, int base);

// Convenience functions with base == 10.
inline bool safe_strto32(base::StringPiece text, int32* value) {
  return safe_strto32_base(text, value, 10);
}

inline bool safe_strto64(base::StringPiece text, int64* value) {
  return safe_strto64_base(text, value, 10);
}

inline bool safe_strtou32(base::StringPiece text, uint32* value) {
  return safe_strtou32_base(text, value, 10);
}

inline bool safe_strtou64(base::StringPiece text, uint64* value) {
  return safe_strtou64_base(text, value, 10);
}

inline bool safe_strtosize_t(base::StringPiece text, size_t* value) {
...
inline bool safe_strto32(const char* str, int32* value) {
 return safe_strto32(base::StringPiece(str), value);
}

inline bool safe_strto32(const std::string& str, int32* value) {
 return safe_strto32(base::StringPiece(str), value);
}
...
inline bool safe_strto64(const char* str, int64* value) {
 return safe_strto64(base::StringPiece(str), value);
}

inline bool safe_strto64(const std::string& str, int64* value) {
 return safe_strto64(base::StringPiece(str), value);
}
...
inline bool safe_strtou32(const char* str, uint32* value) {
 return safe_strtou32(base::StringPiece(str), value);
}

inline bool safe_strtou32(const std::string& str, uint32* value) {
 return safe_strtou32(base::StringPiece(str), value);
}
...
inline bool safe_strtou64(const char* str, uint64* value) {
 return safe_strtou64(base::StringPiece(str), value);
}

inline bool safe_strtou64(const std::string& str, uint64* value) {
 return safe_strtou64(base::StringPiece(str), value);
}
...
bool HexStringToUint128(base::StringPiece hex, uint128* value);
...
// changed.
bool safe_strtob(base::StringPiece str, bool* value);
...
inline std::string SimpleItoa(long i) {  // NOLINT long is OK here
  if (sizeof(i) == 64 / 8) {
...
inline std::string SimpleItoa(unsigned long i) {  // NOLINT long is OK here
  if (sizeof(i) == 64 / 8) {
...
template <typename int_type>
bool SimpleAtoi(const std::string& s, int_type* out) {
