...
class Arg {
 public:
  ...
  Arg(const std::string& value)  // NOLINT(runtime/explicit)
      : piece_(value) {}
  Arg(base::StringPiece value)  // NOLINT(runtime/explicit)
      : piece_(value) {}
  ...
  base::StringPiece piece() const { return piece_; }

 private:
  base::StringPiece piece_;
...
void SubstituteAndAppendArray(
    ...
    const base::StringPiece* args_array, size_t num_args);
...
inline void SubstituteAndAppend(
  ...
  const base::StringPiece args[] = { a0.piece() };
...
inline void SubstituteAndAppend(
  ...
  const base::StringPiece args[] = { a0.piece(), a1.piece() };
  substitute_internal::SubstituteAndAppendArray(output, format,
                                                args, arraysize(args));
}
...
inline void SubstituteAndAppend(
  ...
  const base::StringPiece args[] = { a0.piece(), a1.piece(), a2.piece() };
  substitute_internal::SubstituteAndAppendArray(output, format,
                                                args, arraysize(args));
}
...
// See file comments above for usage.
inline std::string Substitute(base::StringPiece format) {
  std::string result;
