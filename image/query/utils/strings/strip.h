...
bool TryStripPrefixString(base::StringPiece str,
...
inline void StripWhiteSpace(base::StringPiece* str) {
...
inline int TrimString(std::string* s, base::StringPiece remove) {
