...
inline bool CaseEqual(base::StringPiece s1, base::StringPiece s2) {
...
struct CaseLess {
 bool operator()(base::StringPiece s1, base::StringPiece s2) {
...
namespace strings {
inline std::string ToLower(base::StringPiece s) {
...
namespace strings {
inline std::string ToUpper(base::StringPiece s) {
  std::string out(s.data(), s.size());
  UpperString(&out);
  return out;
}
