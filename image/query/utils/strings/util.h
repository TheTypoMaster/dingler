...
#ifndef DINGLER_STRINGS_UTIL_H_
#define DINGLER_STRINGS_UTIL_H_
...
namespace image {
 ...
 namespace strings {
  ...
  base::StringPiece FindEol(base::StringPiece sp);
...
#undef strnprefix
 ...
 inline bool HasPrefixString(base::StringPiece str,
  base::StringPiece prefix) {
  return str.starts_with(prefix);
 }

 // Returns whether str ends with suffix.
 inline bool HasSuffixString(base::StringPiece str,
 ...
 inline bool IsAscii(base::StringPiece str) {
 ...
 void FindShortestSeparator(base::StringPiece start, base::StringPiece limit,
 ...
 // ascending order.
 void InsertString(
  std::string* s, const vector<uint32>& indices, char const* separator);
