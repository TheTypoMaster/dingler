...
#ifndef IMAGE_OPENSOURCE_FILE_FILE_H_
#define IMAGE_OPENSOURCE_FILE_FILE_H_
...
enum Ownership {
 ...
 public:
  ...
  virtual const std::string& CreateFileName() { return create_file_name_; }

 protected:
  explicit File(const std::string& create_file_name);
...
#endif  // IMAGE_OPENSOURCE_FILE_FILE_H_
