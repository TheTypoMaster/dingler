...
struct adaptor_helper {
  ...
  typedef typename if_<
   type_equals_<typename std::iterator_traits<It>::reference,
...
struct ptr_adaptor_helper {
 typedef typename std::remove_pointer<PtrVal>::type     value_type;
  typedef const PtrVal&                             pointer;
  typedef typename std::remove_pointer<PtrVal>::type&    reference;
  typedef typename std::iterator_traits<It>::difference_type difference_type;
  typedef typename std::iterator_traits<It>::iterator_category
      iterator_category;
};
...
class iterator_first {
 private:
  ...
  typedef typename container::gtl::adaptor_helper<It, Val> helper;
...
class iterator_second_ptr {
 private:
  // Helper template to define our necessary typedefs.
  typedef typename container::gtl::ptr_adaptor_helper<It, _PtrVal> helper;
...
class iterator_view_helper {
 public:
  ...
  typedef typename internal::container_traits<C>::size_type
      size_type;
...
class const_iterator_view_helper {
 public:
  ...
  typedef typename gtl::internal::container_traits<C>::size_type
      size_type;
...
struct key_view_type {
  typedef container::gtl::internal::iterator_view_helper<
      C,
...
struct key_view_type<const C> {
 typedef container::gtl::internal::const_iterator_view_helper<
      C,
      iterator_first<typename C::const_iterator> > type;
};
