...
#include "image/query/utils/bits.h"
...
// fabiok: implemented the portable/slow versions
// todo: implement later
int Bits::Log2Floor(uint32 n) {
 return Bits::Log2Floor_Portable(n);
}

int Bits::Log2Floor64(uint64 n) {
 return Bits::Log2Floor64_Portable(n);
}

int Bits::Log2FloorNonZero(uint32 n) {
 return Bits::Log2FloorNonZero_Portable(n);
}

int Bits::Log2FloorNonZero64(uint64 n) {
