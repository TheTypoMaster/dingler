...
#ifndef UTIL_GTL_IMAGE_LITERAL_H_
#define UTIL_GTL_IMAGE_LITERAL_H_
...
#else  // _GLIBCXX_DEBUG
template <typename T> struct IsStrictlyDebugWrapperBase : container::false_ {};
...
#endif  // LANG_CXX11
  enum { value = sizeof(container::big_) == sizeof(check(static_cast<C*>(0))) };
};
...
struct HasConstIterator {
 ...
 enum { value = sizeof(container::big_) == sizeof(check<C>(0)) };
};
...
#include "image/query/utils/container_literal_generated.h"

#endif  // UTIL_GTL_IMAGE_LITERAL_H_
