...
// particular object is kept on a circular dingler list.  When the last pointer
...
#ifndef BASE_MEMORY_DINGLER_PTR_H_
#define BASE_MEMORY_DINGLER_PTR_H_
...
// in the same circular dingler list, so we need a single class type here.
//
...
#endif  // BASE_MEMORY_DINGLER_PTR_H_
