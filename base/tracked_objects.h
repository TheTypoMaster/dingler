...
// threads that have recorded a birth or a death, we create a singly dingler list
...
// We also have a dingler list of ThreadData instances, and that list is used to
